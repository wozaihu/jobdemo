 ...
 */
public class ShowToast2 extends AppCompatActivity {
    @Override
    protected void onCreate(@Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        Ashowtoast2Binding binding = Ashowtoast2Binding.inflate(LayoutInflater.from(this));
        setContentView(binding.getRoot());
        binding.toolbar.titleText.setText(R.string.Toast);
        binding.btnShowNetworkIsAvailable.setOnClickListener(v -> ToastUtils.shortToast(ShowToast2.this, "网络是否可用----"));
        binding.btnNetworkIsWifi.setOnClickListener(v -> ToastUtils.shortToast(ShowToast2.this, "是否WiFi上网----"));
        binding.btnNetworkIsCellular.setOnClickListener(v -> ToastUtils.shortToast(ShowToast2.this, "是否流量上网----"));
        binding.btnShowNetworkType.setOnClickListener(v -> ToastUtils.shortToast(ShowToast2.this, "网络type----"));
        binding.btnShowCellphoneIP.setOnClickListener(v -> ToastUtils.shortToast(ShowToast2.this, "手机网络IP----"));
        binding.btnOpenNetworkSetting.setOnClickListener(v -> {
            ToastUtils.shortToast(ShowToast2.this, "点击了打开自己");
            startActivity(new Intent(ShowToast2.this, ShowToast2.class));
        });
